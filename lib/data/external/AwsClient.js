...
const GCPClient = require('./gcpClient.js');
...
class AwsClient {
    constructor(config) {
        ...
        if (config.gcp) {
            this._client = new GCPClient(this._s3Params);
            this._type = 'GCP';
        } else {
    ...
    put(stream, size, keyContext, reqUids, callback) {
        ...
        if (keyContext.cacheControl !== undefined) {uploadParams.CacheControl = keyContext.cacheControl;
        }
